...
public class TerminalCameraMovement : MonoBehaviour {
    ...
    void FixedUpdate () {
        if (!ClickController.isClickingOnObject && !EventSystem.current.IsPointerOverGameObject(Input.touchCount > 0 ? Input.touches[0].fingerId : -1)) {
