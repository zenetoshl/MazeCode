...
public class Testeee : MonoBehaviour {
    ...
    private void Start () {
        ...
        string resultDouble = OperationManager.StartOperation("(111.5 - (var1 + 3) - 204 + arr[var2]) - 43 * (2.1 * 2.1) + 3 - (2 + 3.23)",TerminalEnums.varTypes.Double, 0);
        ...
        Debug.Log(double.Parse("2.5", CultureInfo.InvariantCulture));
