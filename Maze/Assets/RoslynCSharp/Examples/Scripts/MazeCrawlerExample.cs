...
namespace RoslynCSharp.Example
{
    ...
    public class MazeCrawlerExample : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            domain.RoslynCompilerService.ReferenceAssemblies.Add(typeof(MazeCrawlerExample).Assembly);
            domain.RoslynCompilerService.ReferenceAssemblies.Add(typeof(UnityEngine.Object).Assembly);
            domain.RoslynCompilerService.ReferenceAssemblies.Add(typeof(Stack<>).Assembly);
            domain.RoslynCompilerService.ReferenceAssemblies.Add(typeof(HashSet<>).Assembly);
