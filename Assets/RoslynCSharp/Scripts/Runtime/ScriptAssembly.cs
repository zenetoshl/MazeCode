...
namespace RoslynCSharp
{
    ...
    public sealed class ScriptAssembly
    {
        ...
        private AssemblyChecker securityChecker = null;
        ...
        /// </summary>
        public AssemblyChecker SecurityChecker
        {
            get { return securityChecker; }
        }
        ...
        public bool SecurityCheckAssembly(SecurityRestrictions restrictions)
        {
            ...
            // Create the checker
            securityChecker = AssemblyChecker.InsecureAccessAssembly(rawAssembly);

            // Run code valdiation
            isSecurityValidated = securityChecker.SecurityCheckAssembly(restrictions);
        ...
        /// <returns>True if the assembly passes security verification or false if it fails</returns>
        public bool SecurityCheckAssembly(SecurityRestrictions restrictions, out SecurityReport report)
        {
            // Check for already checked
            if (securityChecker != null)
            {
                report = securityChecker.Report;
                return isSecurityValidated;
            }
            ...
            // Run code validation
            isSecurityValidated = securityChecker.SecurityCheckAssembly(restrictions, out report);
